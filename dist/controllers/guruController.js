...
exports.updateSuccessStory = exports.checkUserApplication = exports.getSuccessStoryStats = exports.getApplicationByUser = exports.getSuccessStoriesByUser = exports.updateSuccessStoryStatus = exports.getSuccessStoryById = exports.getAllSuccessStories = exports.createSuccessStory = exports.updateApplicationStatus = exports.getApplicationById = exports.getAllApplications = exports.submitGuruApplication = void 0;
const client_1 = require("@prisma/client");
const cloudinary_1 = require("../utils/cloudinary");
const emailService_1 = require("../utils/emailService");
const prisma = new client_1.PrismaClient();
// Submit a new guru application
const submitGuruApplication = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { fullName, email, phone, expertise, experience, linkedin, website, bio, motivation } = req.body;
        ...
        const existingApplication = yield prisma.guruApplication.findUnique({
            where: { userId },
            select: { id: true }
        });
        ...
        try {
            if (files) {
                if (files.resume && files.resume.length > 0) {
                    ...
                    const resumeUploadResult = yield (0, cloudinary_1.uploadToCloudinary)(resumeFile.path, 'resumes');
                    resumeUrl = resumeUploadResult.secure_url;
                }
                if (files.profileImage && files.profileImage.length > 0) {
                    const profileImageFile = files.profileImage[0];
                    const profileImageUploadResult = yield (0, cloudinary_1.uploadToCloudinary)(profileImageFile.path, 'profiles');
        ...
        const application = yield prisma.guruApplication.create({
            data: {
                fullName,
                email,
                phone,
...
const getApplicationById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const application = yield prisma.guruApplication.findUnique({
            where: { id },
            include: {
                User: {
                    select: {
...
const updateApplicationStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedApplication = yield prisma.guruApplication.update({
            where: { id },
            data: {
                status,
                notes,
        ...
        if (status === 'APPROVED') {
            ...
            // Send approval email
            const emailSent = yield sendGuruApplicationApprovedEmail(application.email, application.fullName);
            if (!emailSent) {
            ...
            const emailSent = yield sendGuruApplicationRejectedEmail(application.email, application.fullName, notes);
            if (!emailSent) {
...
const sendGuruApplicationApprovedEmail = (to, userName) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  `;
    return (0, emailService_1.sendEmail)(to, subject, html);
});
const sendGuruApplicationRejectedEmail = (to, userName, reason) => __awaiter(void 0, void 0, void 0, function* () {
...
const createSuccessStory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { founderName, companyName, industry, shortDescription, fullStory, achievements, testimonial } = req.body;
        ...
        if (files && files.image && files.image.length > 0) {
            ...
            const imageUploadResult = yield (0, cloudinary_1.uploadToCloudinary)(imageFile.path, 'success-stories');
            imageUrl = imageUploadResult.secure_url;
        }
        // Create the success story
        const successStory = yield prisma.successStory.create({
            data: {
                founderName,
                companyName,
                industry,
...
const getAllSuccessStories = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const successStories = yield prisma.successStory.findMany({
            where,
            include: {
                User: {
                    select: {
...
const getSuccessStoryById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let successStory = yield prisma.successStory.findUnique({
            where: { id },
            include: {
                User: {
                    select: {
...
const updateSuccessStoryStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        ...
        const story = yield prisma.successStory.findUnique({
            where: { id }
        });
        if (!story) {
        ...
        const updatedStory = yield prisma.successStory.update({
            where: { id },
            data: {
                isPublished,
                updatedAt: new Date()
...
const getSuccessStoriesByUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getSuccessStoriesByUser = getSuccessStoriesByUser;
// Get application by user
const getApplicationByUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.getApplicationByUser = getApplicationByUser;
// Get story statistics for a user
const getSuccessStoryStats = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userId } = req.params;
        // Get total count
        const totalCount = yield prisma.successStory.count({
            where: { userId }
        });
        // Get published count
        const publishedCount = yield prisma.successStory.count({
            where: {
                userId,
                isPublished: true
            }
        ...
        const pendingCount = yield prisma.successStory.count({
            where: {
                userId,
                isPublished: false
            }
...
exports.getSuccessStoryStats = getSuccessStoryStats;
// Check if user has already submitted an application
const checkUserApplication = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.params.userId || req.body.userId;
        if (!userId) {
            return res.status(400).json({ error: 'User ID is required' });
...
exports.checkUserApplication = checkUserApplication;
...
const updateSuccessStory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Check if story exists
        const existingStory = yield prisma.successStory.findUnique({
            where: { id },
            select: {
                userId: true,
                imageUrl: true
